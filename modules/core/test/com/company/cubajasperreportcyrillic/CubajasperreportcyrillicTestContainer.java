package com.company.cubajasperreportcyrillic;
...
public class CubajasperreportcyrillicTestContainer extends TestContainer {

    public CubajasperreportcyrillicTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cubajasperreportcyrillic/app.properties",
    ...
    public static class Common extends CubajasperreportcyrillicTestContainer {

        public static final CubajasperreportcyrillicTestContainer.Common INSTANCE = new CubajasperreportcyrillicTestContainer.Common();
